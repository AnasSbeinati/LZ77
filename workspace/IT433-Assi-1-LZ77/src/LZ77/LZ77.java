...
public class LZ77 extends JFrame {
	...
	public LZ77() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(text!="")
				{
				    ...
				    while(index<fileSize)
				    {
				    	...
				    	{
				    	   temp+=LZ77Functions.compressLZ77(text.substring(index, index+=1000));
				    	   index+=1000;
				    	}
				    	else
				    	{
				    		temp+=LZ77Functions.compressLZ77(text);
				    		index=fileSize;
				    	}
				    	temp2+=temp;
				    	}
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(text!="")
				{
				    ...
				    while(index<fileSize)
				    {
				    	...
				    	if(fileSize-index>=1000)
				    	{
				    	   temp+=LZ77Functions.DecompressLZ77(text.substring(index, index+=999));
				    	   index+=1000;
				    	}
				    	else
				    	{
				    		temp+=LZ77Functions.DecompressLZ77(text);
				    		index=fileSize;
				    	}
				    	temp2+=temp;
				    	}
		...
		btnChooseFileTo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				int response=fc.showOpenDialog(LZ77.this);
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				LZ77Functions.CompressFile(textPane.toString());
			}
		});
		button.setEnabled(false);
